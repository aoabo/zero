...
var comm_list = [{
        ...
        list: [{
                ...
                link: [{
                        ...
                        name: "linux命令",
                        url: "https://tool.lu/command/"
                    }, {
                        name: "window工具",
                        url: "https://bigkiss.gitee.io/zero/window_tool/"
                    }, {
                        name: "坚果云",
                        url: "https://www.jianguoyun.com/"
                    }, {
...
! function(o) {
        ...
        function a(t) {
            if (o(t).addClass("active").siblings(".active").removeClass("active"), o(".search-hidden").remove(), o(t).hasClass("baidu")) o(".search-form").attr("action", "https://www.baidu.com/s"), o(".search-keyword").attr({
                ...
                o(".search-form").attr("action", "http://zh.wiki.sxisa.org/w/index.php"), o(".search-keyword").attr({
                    name: "search",
                    placeholder: "维基百科"
                })
